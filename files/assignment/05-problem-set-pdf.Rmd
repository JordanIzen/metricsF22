...
date: "Due by Monday, November 28, 2022"
output:
  pdf_document:
...
a. Using `R` to examine the data, find the average infant mortality rate for cities *with* lead pipes and for cities *without* lead pipes. Then, calculate the difference in mortality rates, and run a $t$-test to determine if this difference is statistically significant.
