...
::: {.column width="50%"}
![](images/meinfrontofsmith.jpg){width="400"}
:::
...
![](images/smbcmathteacher.png){width="300"}
...
![[SMBC](https://www.smbc-comics.com/comic/2010-12-01)](images/smbc2080stats.png){width="300"}
:::
...
- The *sizes* of the two groups (i.e. who gets A vs B) are *very* different
- A [lurking variable]{.hi-purple} in the study is the severity of the case: doctors tended to give treatment B for less severe cases
...
1. [Causal inference]{.hi}: how changes in $\color{purple}{X}$ *cause* changes in $\color{orange}{Y}$
...
2. [Prediction]{.hi}: predict $\color{orange}{\hat{Y}}$ using an estimated $\color{teal}{f}$
  ...
  - [Forecasting]{.hi-purple}: predict future *values* of $Y$ (inflation, sales, GDP)
  - [Classification]{.hi-purple}: predict the *category* of an outcome (success or failure, cat picture or not cat picture)
...
![](images/metrics_website_f21.png)
