...
![](../../slides/2.2-slides_files/figure-revealjs/unnamed-chunk-28-1.png)
...
![](../../slides/images/tdistributionmeme.jpg)
...
```{r, echo=F}
ggplot(data = tibble(x = -4:4))+ # our "data" is just a sequence of x from -4 to 4
  aes(x = x)+
...
conf_int_abstract <- ggplot(data = data.frame(x = -4:4), # our "data" is just a sequence of x from -4 to 4
  ...
  stat_function(fun = dnorm, # dnorm is the normal distributions
                ...
                geom = "area",
                fill="gray")+
  stat_function(fun = dnorm, xlim=c(-2, 2), geom="area", size=2, fill="#e64173")+
...
conf_int_abstract <- ggplot(data = data.frame(x = -4:4), # our "data" is just a sequence of x from -4 to 4
  ...
  stat_function(fun = dnorm, # dnorm is the normal distributions
                ...
                geom = "area",
                fill="gray")+
  stat_function(fun = dnorm, xlim=c(-1.96, 1.96), geom="area", size=2, fill="#e64173")+
