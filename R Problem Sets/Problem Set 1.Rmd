...
## Q6
Start by loading in tidyverse in the data
```{r, message=FALSE}
library(tidyverse)
data("mtcars")
```
...
## Q7
Let's start by loading the data in. Not that the directory I'm using is unique to my computer and yours should be different
