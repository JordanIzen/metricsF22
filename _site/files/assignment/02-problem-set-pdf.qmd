...
date: "Due by Class Wednesday September 28"
format:
  pdf:
...
d. Make or sketch a rough histogram of this data, with the size of each bin being 10 (i.e. 70's, 80's, 90's, 100's). You can draw this by hand or use `R`.
...
6. Redo problem 5 by using the `pnorm()` command in `R`.
