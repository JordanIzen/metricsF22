...
### [tidyr: reshaping/pivoting data](#133)
...
5. `tidyr` for pivoting/reshaping data
...
# tidyr::pivot_longer() wide to long I
...
# tidyr::pivot_longer() wide to long II
...
---
# tidyr::pivot_longer() wide to long III
...
```{r}
ex_wide %>% pivot_longer(c("2000","2010"),
              names_to = "year",
              values_to = "cases")
```
...
# tidyr::pivot_wider() long to wide I
...
# tidyr::pivot_wider() long to wide II
...
# tidyr::pivot_wider() long to wide III
...
```{r}
ex_long %>% pivot_wider(names_from = "type",
                   values_from = "count")
```
