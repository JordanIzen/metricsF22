---
title: "3.4 — Multivariate OLS Estimators — R Practice"
...
- [`speeding_tickets.csv`](https://metricsf22.classes.ryansafner.com/data/speeding_tickets.csv)
...
speed <- read_csv("https://metricsf22.classes.ryansafner.com/data/speeding_tickets.csv")
```
