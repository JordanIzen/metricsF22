...
- All of this is coming when we return to statistics and econometric theory
...
**Data** is the source of our data. As part of the `tidyverse`, `ggplot2` requires data to be [“tidy”]{.hi-purple}^[Data “tidyness” is the core element of all `tidyverse` packages. Much more on all of this soon]:
...
```
- Using `dodge` places bars next to eachother as opposed to stacked
:::
::: {.column width="50%"}
```{r}
#| echo: false
