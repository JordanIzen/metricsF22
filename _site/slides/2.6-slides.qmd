...
::: columns
::: {.column width="50%"}
- Recall the [68-95-99.7% empirical rule]{.hi-purple} for (standard) normal distributions!^[I’m playing fast and loose here, we can’t actually use the normal distribution, we use the Student’s t-distribution with n-k-1 degrees of freedom. But there’s no need to complicate things you don’t need to know about.]
