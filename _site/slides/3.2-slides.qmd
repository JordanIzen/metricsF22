...
::: columns
::: {.column width="50%"}
![](images/rctparachutes1.jpg){width=600 fig-align="center"}
:::
::: {.column width="50%"}
...
:::
::: {.column width="50%"}
![](images/rctparachutes2.jpg){width=600 fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](images/ladderofcausation.png){width=550 fig-align="center"}
:::
::: {.column width="50%"}
![](images/bookofwhy.jpg)
:::
...
:::
::: {.column width="50%"}
- Simultaneous [“credibility revolution”]{.hi} in econometrics (c.1990s—2000s)
...
::: columns
::: {.column width="50%"}
- The *sine qua non* of causal claims are [counterfactuals]{.hi}: what would $Y$ have been if $X$ had been different?
...
> [Minimal sufficient adjustment sets]{.hi-purple} containing background, location, year for estimating the total effect of educ on wage:
...
::: columns
::: {.column width="50%"}
- Confounders are the DAG-equivalent of [omitted variable bias]{.hi} (next class)
