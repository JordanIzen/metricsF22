...
- [Random assignment]{.hi-turquoise} to groups ensures that the *only* differences between members of the treatment(s) and control groups is *receiving treatment or not* (even better with large $n$)
  ...
  - If assignment truly is random (and the sample large enough), then there will be a balance of observable and unobservables between groups
...
- Can we interpret differences in health between having insurance and not as causal? Is there selection bias?
...
&= \color{#314f4f}{Avg(\delta_i)}+\underbrace{\color{#e64173}{Avg(}\color{#6A5ACD}{Y_i^{0}}\color{#e64173}{|T=1)}-\color{#6A5ACD}{Avg(Y_i^{0}|T=0)}}_{\color{#FFA500}{\text{selection bias}}}\\
...
- [Control group]{.hi-purple} is not a good counterfactual for [treatment group]{.hi} 
