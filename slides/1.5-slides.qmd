...
# The Office Model {background-color="#314f4f" .centered}
...
:::
::: {.column width="40%"}
![](images/msofficemodel.png){fig-align="center"}
:::
:::
...
![](images/drawanowl.jpg){fig-align="center"}
...
:::
::: {.column width="40%"}
![](images/rmdout.png){fig-align="center"}
:::
:::


# The Plain Text Model {background-color="#314f4f" .centered}
...
# Quarto {background-color="#314f4f" .centered}
...
::: {.column width="50%"}
#### Output
![The tidyverse](images/tidyverse1.png)

![dplyr logo](https://dplyr.tidyverse.org/logo.png)
:::
:::

- Read the [Quarto Documentation on figures](https://quarto.org/docs/authoring/figures.html) for more.
...
# Rendering Your Documents {background-color="#314f4f" .centered}
...
# Project-Oriented Workflow {background-color="#314f4f" .centered}
...
# Version Control {background-color="#314f4f" .centered}
...
::: columns
::: {.column width="50%"}
![](images/dropbox.png){fig-align="center"}
...
![](images/mydropbox2.png){fig-align="center"}

## Smart Sync

![](images/dropboxsmartsync.png){fig-align="center"}
...
::: columns
::: {.column width="50%"}
![](images/gitbranches.png){fig-align="center"}
:::
::: {.column width="50%"}
...
![](images/basic-remote-workflow.png){fig-align="center"}
