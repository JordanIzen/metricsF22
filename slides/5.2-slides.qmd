...
![](images/federalismnaturalexperiements.png){fig-align=center}
...
- The [difference-in-differences]{.hi} (aka [“diff-in-diff”]{.hi} or [“DND”]{.hi}) estimator identifies treatment effect by differencing the difference pre- and post-treatment values of $Y$ between treatment and control groups
...
![](images/CardKreuger5.png){fig-align=center width=700}
