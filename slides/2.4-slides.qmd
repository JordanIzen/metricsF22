...
::: {.column width="50"}
2. [Prediction]{.hi-purple}: predict $\color{orange}{\hat{Y}}$ using an estimated $\color{teal}{f}$
...
::: columns
::: {.column width="60%"}
- We use econometricas to [identify]{.hi} causal relationships & make [inferences]{.hi-purple} about them:
