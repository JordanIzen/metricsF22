...
no_south_reg <- lm(wage ~ northeast + northcen + west, data = wages)
no_west_reg <- lm(wage ~ northeast + northcen + south, data = wages)
```
...
```{r}
library(modelsummary)
modelsummary(models = list("Wage" = no_noreast_reg,
                           "Wage" = no_northcen_reg,
                           "Wage" = no_south_reg,
                           "Wage" = no_west_reg),
             fmt = 2, # round to 2 decimals
             output = "html",
