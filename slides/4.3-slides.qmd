...
- What do the different coefficients $(\beta)$’s tell us? 
  ...
  - We will build some intuition about how we interpret this sort of interaction now
...
\begin{align*}
\Delta Y &= \beta_1 \Delta X_{1}+ \beta_3 X_{2} \Delta X_{1}\\
\color{#6A5ACD}{\frac{\Delta Y_i}{\Delta X_{1}}} &= \color{#6A5ACD}{\beta_1+\beta_3 X_{2}}\\ 	
\end{align*}
...
- Likewise: [the effect of $X_2 \rightarrow Y$ depends on the value of $X_1$]{.hi-purple}
