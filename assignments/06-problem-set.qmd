...
<p style="text-align:center"><a target="_blank" href="/files/assignment/06-problem-set.zip"><span class="btn btn-primary btn-lg"><i class="fas fa-file-archive"></i> R Project</a></span> <a target="_blank" href="https://posit.cloud/spaces/270168/content/5073789"><span class="btn btn-primary btn-lg"><i class="fas fa-cloud"></i> R Studio Cloud</a></span></p>

# Answers

<p style="text-align:center"><a target="_blank" href="/files/assignment/06-problem-set-answers.html"><span class="btn btn-primary btn-lg"><i class="fas fa-external-link-square-alt"></i> html </a></span> <a target="_blank" href="/files/assignment/06-problem-set-answers.zip"><span class="btn btn-primary btn-lg"><i class="fas fa-file-archive"></i> R Project</a></span> <a target="_blank" href="https://posit.cloud/spaces/270168/content/5073789"><span class="btn btn-primary btn-lg"><i class="fas fa-cloud"></i> R Studio Cloud</a></span></p>
