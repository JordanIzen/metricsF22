...
::: callout-tip
Check back here later after we cover writing empirical papers in class. More resources will be posted afterwards!
:::
...
- [<i class="fas fa-chalkboard-teacher"></i> How to Write a Good Paper (Slides)](https://microf22.classes.ryansafner.com/slides/paper-slides.html)
...
Don't forget to check out the [Data Resources](https://metricsF22.classes.ryansafner.com/resources/data.qmd) for ideas and examples of how and where to find data sets.
...
|------------|--------|----------|-------------|
| Abstract | 5 | Fri Oct 21 | Short summary of your ideas |
| Literature Review | 10 | Fri Nov 4 | 1-3 paragraphs on 2-3 scholarly sources |
| Data Description | 10 | Fri Nov 18 | Description of data sources, and some summary statistics |
