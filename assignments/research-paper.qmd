...
Don't forget to check out the [Data Resources](https://metricsf22.classes.ryansafner.com/resources/data.html) for ideas and examples of how and where to find data sets.

## Some Titles of Former Students' Papers
